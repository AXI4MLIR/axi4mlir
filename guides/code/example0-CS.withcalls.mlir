    ...
    scf.for %arg3 = %c0 to %c16 step %c4 {
      scf.for %arg4 = %c0 to %c8 step %c4 {
        scf.for %arg5 = %c0 to %c32 step %c4 {
          ...
          memref.store %c1_i32, %8[] : memref<i32>
          ...
          %12 = memref.subview %arg0[%arg3, %arg5] [4, 4] [1, 1] : memref<16x32xi32> to memref<4x4xi32, #map0>
          %13 = memref.cast %12 : memref<4x4xi32, #map0> to memref<*xi32>
          ...
          memref.store %c2_i32, %16[] : memref<i32>
          ...
          %20 = memref.subview %arg1[%arg5, %arg4] [4, 4] [1, 1] : memref<32x8xi32> to memref<4x4xi32, #map1>
          %21 = memref.cast %20 : memref<4x4xi32, #map1> to memref<*xi32>
          %22 = call @copy_to_inbuffer_i32(%21, %c1_i32) : (memref<*xi32>, i32) -> i32
          %23 = call @dma_start_send(%c16_i32, %c1_i32) : (i32, i32) -> i32
          call @dma_wait_send() : () -> ()
          %24 = memref.alloc() : memref<i32>
          memref.store %c4_i32, %24[] : memref<i32>
        ...
        memref.store %c8_i32, %0[] : memref<i32>
        ...
        %4 = memref.subview %arg2[%arg3, %arg4] [4, 4] [1, 1] : memref<16x8xi32> to memref<4x4xi32, #map1>
        %5 = memref.cast %4 : memref<4x4xi32, #map1> to memref<*xi32>
        %6 = call @dma_start_recv(%c16_i32, %c1_i32) : (i32, i32) -> i32
        call @dma_wait_recv() : () -> ()
        %7 = call @copy_from_outbuffer_i32(%5, %c1_i32) : (memref<*xi32>, i32) -> i32
      }
    }
    call @dma_free() : () -> ()
    return
