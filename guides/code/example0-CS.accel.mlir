    ...
    scf.for %arg3 = %c0 to %c16 step %c4 {
      scf.for %arg4 = %c0 to %c8 step %c4 {
        scf.for %arg5 = %c0 to %c32 step %c4 {
          ...
          %3 = accel.sendLiteral %c1_i32, %c0_i32_0 : (i32, i32) -> i32
          %4 = memref.subview %arg0[%arg3, %arg5] [%c4, %c4] [1, 1] : memref<16x32xi32> to memref<?x?xi32, #map0>
          %5 = accel.send %4, %3 : (memref<?x?xi32, #map0>, i32) -> i32
          %c2_i32 = arith.constant 2 : i32
          %6 = accel.sendLiteral %c2_i32, %c0_i32_0 : (i32, i32) -> i32
          %7 = memref.subview %arg1[%arg5, %arg4] [%c4, %c4] [1, 1] : memref<32x8xi32> to memref<?x?xi32, #map1>
          %8 = accel.send %7, %6 : (memref<?x?xi32, #map1>, i32) -> i32
          %c4_i32 = arith.constant 4 : i32
          %9 = accel.sendLiteral %c4_i32, %c0_i32_0 : (i32, i32) -> i32
        }
        %c0_i32 = arith.constant 0 : i32
        %c8_i32 = arith.constant 8 : i32
        %0 = accel.sendLiteral %c8_i32, %c0_i32 : (i32, i32) -> i32
        %1 = memref.subview %arg2[%arg3, %arg4] [%c4, %c4] [1, 1] : memref<16x8xi32> to memref<?x?xi32, #map1>
        %2 = accel.recv %1, %0 : (memref<?x?xi32, #map1>, i32) -> i32
      }
    }
    return
  }
